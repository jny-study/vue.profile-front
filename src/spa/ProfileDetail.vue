  ...
  <div class='profile-new'>
    <div class='new-container'>
      ...
      <div class='profile-detail-container'>
        <button class='profile-detail-button' type='button' v-if='isOpen' @click='toggleDetailBox()'>상세 정보 닫기</button>
        <button class='profile-detail-button' type='button' v-else @click='toggleDetailBox()'>상세 정보 보기</button>
